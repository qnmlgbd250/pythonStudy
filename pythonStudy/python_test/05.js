function get_m_value() {
    ...
    function _0x11a7a2(_0x193f00, _0x1cfe89) {
        ...
        // _0x193f00 = [959657521, 942879536, 808464944, 32816, '','','','','','','','','','', 104]
        var _0x42fb36 = 16;
        ...
        try {
            ...
            if (op > 0x14) {
                ...
                $_zw = [0x1, 0x8, 0x2, 0x4, 0x17, 0x2d, 0x8, 0xf, 0x51, 0x44, 0xd, 0x48, 0x46];
            }
        }
        ...
        console.log([_0x3e0c38, _0xdb4d2c, _0x1724c5, _0x257ec6])
    ...
    _$Wa = _0x12eaf3();
    pr['push'](_0x474032(_$Wa));
    console.log('第三次的_$Jy:' + _$Jy, '第三次的_$tT:' + _$tT)
    ...
    _$Wa = _0x12eaf3();
    pr['push'](_0x474032(_$Wa));
    console.log('第四次的_$Jy:' + _$Jy, '第四次的_$tT:' + _$tT)

    //第五次tt
    _$Jy = -405537848;
    _$tT = -660478335;
    console.log('第五次的_$Jy:' + _$Jy, '第五次的_$tT:' + _$tT)
    _$yw = new Date()['valueOf']()['toString']();
    pr['push'](_0x474032(_$yw));
    var CryptoJS = require("crypto-js");
    _$Ww = CryptoJS['enc']['Utf8']['parse'](String(pr));
    _$is = new Date()['valueOf']()['toString']();
    _$qF = CryptoJS['enc']['Utf8']['parse'](new Buffer(_$is).toString('base64')['slice'](0x0, 0x10))
    _0x29dd83 = CryptoJS['AES']['encrypt'](_$Ww, _$qF, {
    ...
    return [pr[4], RM4hZBv0dDon443M, _$yw, String(_$Wa)]
}
